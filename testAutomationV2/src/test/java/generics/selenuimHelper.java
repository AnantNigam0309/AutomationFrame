...
public class selenuimHelper extends constant{
	...
	public static void deselectAllFromDropBox(WebElement element){
		try{
			...
			CaptureScreenshot("deselectAllFromDropBox");
			String[] txt=element.toString().split("->");
			String elementString = txt[1].replaceAll("]]","]");
	...
	public static void moveToElement(WebElement element){
		...
		try{
			...
			CaptureScreenshot("moveToElement");
	...
	public static void moveToElementAndClick(WebElement element){
		...
		try{
			...
			CaptureScreenshot("moveToElementAndClick");
	...
	public static void verifyElementDisplayed(WebElement element){
		...
		try{
			...
			CaptureScreenshot("verifyElementDisplayed");
	...
	public static void ActionSendKeys(CharSequence...keysToSend){
	 	try {
			...
			CaptureScreenshot("ActionSendKeys");
	...
	public static void SwitchToFrame(String frameId){
		try {
			...
			CaptureScreenshot("SwitchToFrame");
	...
	public static void SwitchToDefaultWindow(){
		try {
			...
			CaptureScreenshot("SwitchToDefaultWindow");
	...
	public static void SwitchToFrame(WebElement element){
		try {
			...
			CaptureScreenshot("SwitchToFrame");
			log.info("Exception Occured while Swithing to frame , Message Recieved :"+exp.getMessage());
		}
	}
	...
	public static void executeJavaScript(String jsScript,String jsObject){
		try{
			...
			CaptureScreenshot("executeJavaScript");
	...
	public static void waitForElementExplicitly(WebElement element){
		try{
			...
			CaptureScreenshot("waitForElementExplicitly");
